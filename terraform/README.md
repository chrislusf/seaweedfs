...
required. The design and rationale live in [DEVELOPMENT_PLAN.md](DEVELOPMENT_PLAN.md).
...
- CA in Vault PKI (currently TF-generated, so the CA key lives in state — see
  DEVELOPMENT_PLAN.md §6/§12). KMS decrypt in the IAM policy is scoped by
...
material. See DEVELOPMENT_PLAN.md §6.
